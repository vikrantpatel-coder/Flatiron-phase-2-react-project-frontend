function createSuperheroesJSON(data) {
  const superheroes = data.map((superheroes) => ({
    id: superheroes.id,
    name: superheroes.name,
    intelligence: superheroes.powerstats.intelligence,
    strength: superheroes.powerstats.strength,
    speed: superheroes.powerstats.speed,
    durability: superheroes.powerstats.durability,
    power: superheroes.powerstats.power,
    combat: superheroes.powerstats.combat,
    images: {
      md: superheroes.images.md,
    },
  }));
...
// My original data of Superheroes
const originalData = [
  {
    id: 1,
    name: "A-Bomb",
...
const jsonData = createSuperheroesJSON(originalData);
console.log(jsonData);

export default createSuperheroesJSON;
